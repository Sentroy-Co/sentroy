...
function SheetContent({
  ...
  /**
   * Backdrop overlay'i atla — sheet alttan slide-up gelirken arkadaki
   * UI (örn. multitrack editor) hâlâ etkileşilebilir kalsın diye.
   * Default false (overlay açık), opt-in true.
   */
  noOverlay?: boolean
}) {
  return (
