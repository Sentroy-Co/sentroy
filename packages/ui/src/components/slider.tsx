...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      // min-h-4 default: thumb 16px overflow etmesin diye Root touch area
      // garantili. Caller h-N override ederse thumb visually clipped olur
      // ve pointer event coord calc edge'e takılır.
      className={cn(
        "data-horizontal:w-full data-horizontal:min-h-4 data-vertical:h-full",
        className,
      )}
      data-slot="slider"
      ...
      <SliderPrimitive.Control className="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        ...
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            // index ZORUNLU — base-ui'nin thumb'ı hangi value index'ine
            // bind edeceğini bilmesi için (özellikle SSR + multi-thumb).
            // Tek thumb'da bile olmazsa drag eventleri value güncellemiyor.
            index={index}
