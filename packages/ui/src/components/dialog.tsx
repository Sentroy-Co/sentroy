...
function DialogContent({
  ...
  /** Override classes on the backdrop — useful for nested dialogs that
   *  need a higher z-index so the backdrop sits above the parent
   *  dialog's own overlay. Passed straight to the Backdrop primitive. */
