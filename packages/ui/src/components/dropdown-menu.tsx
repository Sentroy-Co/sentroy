...
function DropdownMenuContent({
  ...
  > & {
    /** Override portal target — useful inside `requestFullscreen`
     *  containers, where `document.body`-level portals fall outside
     *  the fullscreen subtree and stay invisible. Caller passes the
