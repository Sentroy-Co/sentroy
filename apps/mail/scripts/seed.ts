...
function buildTestimonials(now: Date): TestimonialSeed[] {
  const data: Array<{
    ...
    },
    {
      ...
      quote: {
        en: "The self-hosted option sealed it for us. Our data never leaves our cluster and operations stays boring.",
        tr: "Self-hosted secenegi isi bizim icin kesin yapti. Verilerimiz cluster'imizdan cikmiyor ve operasyonlar sikici kaliyor.",
      },
    },
    {
      name: "Chiamaka Obi",
