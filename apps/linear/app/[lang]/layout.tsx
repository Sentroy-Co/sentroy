...
// TipTap rich text içerik stilleri — globals.css'ten SONRA gelmeli.
import "../rt-content.css"

export const metadata: Metadata = {
  title: { default: "Linear Lite", template: "%s | Linear Lite" },
  description: "Lightweight Linear front-end for your team's requests",
}
